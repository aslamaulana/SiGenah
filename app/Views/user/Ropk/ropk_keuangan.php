		...
		<table id="example1" class="table table-bordered display nowrap table-responsive">
			<thead>
				<tr>
					...
					<th rowspan="2" style="width:700px;">Tahap Aktivitas</th>
			...
			<tbody>
				...
				<tr style="background-color:beige;">
					<td colspan="4"><b>Kumulatif per Bulan (%)</b></td>
					<td></td>
					<td class="text-right"><?= !empty($acu) ? $s2 = round(($bb1 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s2 = round(($bb2 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s3 = round(($bb3 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s4 = round(($bb4 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s5 = round(($bb5 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s6 = round(($bb6 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s7 = round(($bb7 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s8 = round(($bb8 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s9 = round(($bb9 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s10 = round(($bb10 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s11 = round(($bb11 / array_sum($acu)) * 100, 2) : '-'; ?></td>
					<td class="text-right"><?= !empty($acu) ? $s12 = round(($bb12 / array_sum($acu)) * 100, 2) : '-'; ?> </td>
					<td></td>
				</tr>
			</tbody>
		</table>
