	...
	<script type="text/javascript">
		...
		function drawChart() {
			var data = new google.visualization.arrayToDataTable(
				[
					["BULAN", "ROPK Keuangan"],
					['Januari', <?= round(($bb1 / array_sum($acu)) * 100, 2); ?>],
					['Februari', <?= round(($bb2 / array_sum($acu)) * 100, 2); ?>],
					['Maret', <?= round(($bb3 / array_sum($acu)) * 100, 2); ?>],
					['April', <?= round(($bb4 / array_sum($acu)) * 100, 2); ?>],
					['Mei', <?= round(($bb5 / array_sum($acu)) * 100, 2); ?>],
					['Juni', <?= round(($bb6 / array_sum($acu)) * 100, 2); ?>],
					['Juli', <?= round(($bb7 / array_sum($acu)) * 100, 2); ?>],
					['Agustus', <?= round(($bb8 / array_sum($acu)) * 100, 2); ?>],
					['September', <?= round(($bb9 / array_sum($acu)) * 100, 2); ?>],
					['Oktober', <?= round(($bb10 / array_sum($acu)) * 100, 2); ?>],
					['November', <?= round(($bb11 / array_sum($acu)) * 100, 2); ?>],
					['Desember', <?= round(($bb12 / array_sum($acu)) * 100, 2); ?>]
				]);
