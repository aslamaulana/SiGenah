...
<div class="card-body">
	...
	<table id="example1" class="table table-bordered display nowrap table-sm">
		...
		$fbb12 = (!empty($fis1) ? array_sum($fis1) : '0') + (!empty($fis2) ? array_sum($fis2) : '0') + (!empty($fis3) ? array_sum($fis3) : '0') + (!empty($num4) ? array_sum($num4) : '0') + (!empty($num5) ? array_sum($num5) : '0') + (!empty($num6) ? array_sum($num6) : '0') + (!empty($num7) ? array_sum($num7) : '0') + (!empty($num8) ? array_sum($num8) : '0') + (!empty($num9) ? array_sum($num9) : '0') + (!empty($num10) ? array_sum($num10) : '0') + (!empty($num11) ? array_sum($num11) : '0') + (!empty($num1) ? array_sum($num12) : '0');
		?>
		<tbody>
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres1['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b1' . '/Januari?keu=' . number_format($bb1, 0, ',', '.') . '&fis=' . number_format($fbb1, 0, ',', '.')); ?>">
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres2['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b2' . '/Februari?keu=' . number_format($bb2, 0, ',', '.') . '&fis=' . number_format($fbb2, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres3['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b3' . '/Maret?keu=' . number_format($bb3, 0, ',', '.') . '&fis=' . number_format($fbb3, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres4['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b4' . '/April?keu=' . number_format($bb4, 0, ',', '.') . '&fis=' . number_format($fbb4, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres5['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b5' . '/Mei?keu=' . number_format($bb5, 0, ',', '.') . '&fis=' . number_format($fbb5, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres6['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b6' . '/Juni?keu=' . number_format($bb6, 0, ',', '.') . '&fis=' . number_format($fbb6, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres7['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b7' . '/Juli?keu=' . number_format($bb7, 0, ',', '.') . '&fis=' . number_format($fbb7, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres8['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b8' . '/Agustus?keu=' . number_format($bb8, 0, ',', '.') . '&fis=' . number_format($fbb8, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres9['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b9' . '/September?keu=' . number_format($bb9, 0, ',', '.') . '&fis=' . number_format($fbb9, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres10['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b10' . '/Oktober?keu=' . number_format($bb10, 0, ',', '.') . '&fis=' . number_format($fbb10, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres11['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b11' . '/November?keu=' . number_format($bb11, 0, ',', '.') . '&fis=' . number_format($fbb11, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
			...
			<tr>
				...
				<td class="align-top text-right">
					<?php if (isset($progres12['id_emonev_progres'])) { ?>
						<a href="<?= base_url('/user/simonela/simonela/progres_edit/' . $DT['id_ropk_keuangan_rkpd_kegiatan_sub'] . '/' . 'b12' . '/Desember?keu=' . number_format($bb12, 0, ',', '.') . '&fis=' . number_format($fbb12, 0, ',', '.')); ?>">
							<li class="btn btn-block btn-warning btn-xs" active><i class="nav-icon fa fa-chart-pie"></i> Progres</li>
						</a>
					<?php } else { ?>
