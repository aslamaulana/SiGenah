		...
		<table class="table table-bordered">
			<tr>
				<td colspan="3">Renstra Sub Kegiatan<br>
					"Dalam proses pengisian renstra sub kegiatan ke aplikasi, ada kemungkinan anda akan mengalami error data (Woopsh!), error data ini kemungkinan besar di sebabkan kesalahan pengisian data pagu di Renstra Sub Kegiatan.
					...
					Cara yang dapat dilakukan jika terjadi error (Woopsh!):<br>
