	...
	public function grafik()
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_organisasi',
				'title' => 'User | RA',
				'lok' => '<a onclick="history.back(-1)" href="#">RKO</a> -> <b>Grafik</b>',
	...
	public function organisasi_add($id)
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_organisasi',
				'title' => 'User | RA',
				'lok' => '<a onclick="history.back(-1)" href="#">RKO</a> -> <b>Tambah Tahap Aktivitas</b>',
				'DT' => $this->ropk_kegiatan_sub->find($id),
	...
	public function import($id)
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_organisasi',
				'title' => 'User | RA',
				'lok' => '<a onclick="history.back(-1)" href="#">RKO</a> -> <b>Import Data</b>',
				'DT' => $this->ropk_kegiatan_sub->find($id),
			];
