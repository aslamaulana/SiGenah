...
class Ropk_keuangan extends BaseController
{
	...
	public function grafik()
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_keuangan',
				'title' => 'User | Ro',
				'lok' => '<a onclick="history.back(-1)" href="#">RKK</a> -> <b>Grafik</b>',
	...
	public function keuangan_add($id)
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_keuangan',
				'title' => 'User | RO',
				'lok' => '<a onclick="history.back(-1)" href="#">RKK</a> -> <b>Tambah Tahap Aktivitas</b>',
	...
	public function ropk_keuangan_kegiatan_sub_edit($id)
	{
		if (has_permission('User')) :
			$data = [
				...
				'lok' => '<a onclick="history.back(-1)" href="#">RO</a> -> <b>Ubah Data</b>',
	...
	public function import_rkpd()
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_keuangan',
				'title' => 'User | RA',
				'lok' => '<a onclick="history.back(-1)" href="#">RO</a> -> <b>Import Data</b>',
			];
	...
	public function import($id)
	{
		if (has_permission('User')) :
			$data = [
				...
				'mn' => 'ropk_keuangan',
				'title' => 'User | RO',
				'lok' => '<a onclick="history.back(-1)" href="#">RKK</a> -> <b>Import Data</b>',
				'DT' => $this->ropk_kegiatan_sub->find($id),
			];
	...
	public function export()
	{
		...
		$writer = new Xlsx($spreadsheet);
		$filename =  'RKK- ' . substr($_GET['s'], 0, 200) . '... (' . $_SESSION['tahun'] . ') - ' . date('Y-m-d-His');
		$extension = 'Xlsx';
		$writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheet, $extension);
		header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
		header("Content-Disposition: attachment; filename=\"$filename.{$extension}\"");
